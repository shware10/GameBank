...
public class GameScreen7 implements Screen {
    ...
    public void show() {
        ...
        leftJumpAnimation = new Animation<>(0.1f, leftJumpAtlas.findRegions("LeftJump"), Animation.PlayMode.LOOP);
        rightJumpAnimation = new Animation<>(0.1f, rightJumpAtlas.findRegions("RightJump"), Animation.PlayMode.LOOP);
