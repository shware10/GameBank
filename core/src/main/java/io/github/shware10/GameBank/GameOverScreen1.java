...
public class GameOverScreen1 implements Screen {
    ...
    public void render(float delta) {
        ...
        float GameOverWidth = layoutGameOver.width;
        float GameOverHeight = layoutGameOver.height;
        ...
        // 텍스트 렌더링
        batch.begin();
        GameOverFont.draw(batch, textGameOver, (Gdx.graphics.getWidth() - GameOverWidth) / 2f, Gdx.graphics.getHeight() - 430);
